...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def init_dock(self) -> None:
        ...
        stats_widget, stats_dock = self.create_dock(
            OrderStatsMonitor, _("委托统计"), QtCore.Qt.DockWidgetArea.RightDockWidgetArea
        )
        ...
        self.tabifyDockWidget(order_dock, stats_dock)
