...
DFITCSEC_ED_PreAcceptedOffers = 76
DFITCSEC_ED_RelievePreAcceptedOffers = 77
DFITCSEC_ED_AfterHoursPriceBuying = 178
DFITCSEC_ED_AfterHoursPriceSelling = 179
DFITCSEC_ED_SoldBackRevoke = 212
...
DFITCSEC_OT_SZBlockTradeClosingPrice = 106
DFITCSEC_OT_SZBlockTradeAveragePrice = 107
DFITCSEC_OT_SHOtherBestPrice = 4
DFITCSEC_OT_SHBestPrice = 5
DFITCSEC_OT_SHBlockTradeClosingPrice = 6
...
DFITCSEC_OC_MarketmakeQuotation = 7
DFITCSEC_OC_MarketmakeQuotationWithdraw = 9
DFITCSEC_OT_CALL = 1
DFITCSEC_OT_PUT = 2
...
SYSINFO_MAC = 1
SYSINFO_NETPORT = 6
DFITCSEC_OC_NormalEntrust = 0
DFITCSEC_OC_BatchEntrust = 1
DFITCSEC_OT_ForceCloseEntrust = 2
DFITCSEC_OC_QuotedPriceRepurchase = 3
DFITCSEC_OC_AppointmentRepurchase = 4
DFITCSEC_OC_PledgeRepurchase = 5
DFITCSEC_OC_AllCustodyTransfer = 6
DFITCSEC_OC_MarketmakeBilateralQuotation = 7
DFITCSEC_OC_AgreementRepurchase = 8
DFITCSEC_DP_TransferInvestment = "0"
DFITCSEC_DP_Csah = "1"
DFITCSEC_SN_UnlimitedTradableShares = "00"
DFITCSEC_SN_PersonalRestrictedSharesAfterIPO = "01"
DFITCSEC_SN_OrganizationRestrictedSharesAfterIPO = "03"
DFITCSEC_SN_ExecutiveLockInShares = "04"
DFITCSEC_SN_PersonalRestrictedSharesBeforeIPO = "05"
DFITCSEC_SN_OrganizationRestrictedSharesBeforeIPO = "06"
DFITCSEC_CT_FIN = 1
DFITCSEC_BT_SLO = 2
DFITCSEC_STF_In = 1
DFITCSEC_STF_Out = 2
DFITCSEC_SP_FinancingContractObject = 1
DFITCSEC_SP_SecuritiesContractObject = 2
DFITCSEC_SP_Collateral = 4
